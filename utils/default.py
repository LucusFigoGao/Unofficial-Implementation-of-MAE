...
-----------------------------------
    ...
    Time:        2022/09/27 11:29:04
    Editor:      Figo
-----------------------------------
'''

DEFAULT_DATA_ROOT = {
    "cifar10": "/data/dataset/data/CIFAR10/", 
    "cifar100": "/data/dataset/data/CIFAR100/", 
    "imagenet": "/data/dataset/ILSVRC2012", 
}
...
TRAIN_TRANSFORMS_EASY = transforms.Compose([
    transforms.RandomHorizontalFlip(p=0.5), 
    transforms.RandomVerticalFlip(p=0.5), 
    transforms.ToTensor()
])

TEST_TRANSFORMS_EASY = transforms.Compose([
    transforms.ToTensor()
])
